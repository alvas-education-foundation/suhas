...
k = 0 # Index of last element in a partition p[k] = n # Initialize first partition

#	as number itself while True:

printArray(p, k + 1) rem_val = 0

while k >= 0 and p[k] == 1: rem_val += p[k]

k -= 1 if k < 0: print() return p[k] -= 1
